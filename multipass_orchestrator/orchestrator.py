    ...
    def build_environment(self):
        ...
        for vm_name in build:
            ...
            with open(build_script, 'w', newline="\n") as fh:
                fh.write("#!/bin/bash\n\n")
                fh.write("echo multipass-orchestrator build started $(date) >> .build_out.log\n\n")
                ...
                fh.write("\necho multipass-orchestrator build ended $(date) >> .build_out.log\n")
    ...
    def run_environment(self):
        ...
        for vm_name in run:
            ...
            with open(run_script, 'w', newline="\n") as fh:
                fh.write("#!/bin/bash\n\n")
                fh.write("echo multipass-orchestrator run started $(date) >> .run_out.log\n\n")
                ...
                fh.write("\necho multipass-orchestrator run ended $(date) >> .run_out.log\n")
